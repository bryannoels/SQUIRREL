...
public class TestPageCorrect extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correctButton.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#99CC29")));
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (questionNumber < 3)
            {
                ...
                intent = new Intent(TestPageCorrect.this, TestPage.class);
            }
            else
                intent = new Intent(TestPageCorrect.this, ResultPage.class);
