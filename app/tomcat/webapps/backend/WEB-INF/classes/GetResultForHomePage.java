...
@WebServlet("/getResultForHomePage")
public class GetResultForHomePage extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        + request.getParameter("student_id") + " and q.module_id =  " + request.getParameter("module_id") + " and r.result = 1";
